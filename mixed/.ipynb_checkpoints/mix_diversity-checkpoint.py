...
#### mix 데이터처럼 percentage filtering했을 경우 diversity 분석 ###
##############################################################
...
-m /home/grlee/raw/mixed/mixed2_221124/H18_except_feces/H18_byweek_NGS_metadata_f.tsv~
-e vector 선택하기 (ex.faith_pd_vector)
-a distance matrix 선택하기 core metrix중에서 고르는거 (ex.weighted_unifrac_distance_matrix)
-c metadata column선택하기 (beta과정에서 필요)
-v 앞에서 사용했던 percent cut value (asv filtering 수치)
'''
...
--o-masked-alignment {} \
--o-tree {} \
--o-rooted-tree {}".format(filtering_outseq, out_alignment, out_maskedalignment, out_tree, out_rootedtree)
os.system(cmd)
